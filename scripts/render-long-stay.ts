...
<section class="stay-section stay-white"><div class="stay-wrap"><div class="stay-offer"><div><p class="stay-eyebrow">${escape(ui.offerEyebrow)}</p><h2>${escape(ui.offerTitle)}</h2><p>${escape(ui.offerText)}</p></div><div>${cta()}<a class="stay-link" href="#foto">${escape(ui.viewPhotos)} →</a></div></div></div></section>
