...
const COPY: Record<string, AdvantagesCopy> = {
  ru: {
    ...
    items: [
      ...
      { title: 'Парковка', desc: 'Парковочное место для гостей Casa Marittima.' },
  ...
  en: {
    ...
    items: [
      { title: 'New renovation', desc: 'A modern interior and new furniture for a comfortable stay.' },
      ...
      { title: 'Parking', desc: 'Guest parking is available for Casa Marittima.' },
  ...
  it: {
    ...
    items: [
      { title: 'Ristrutturazione recente', desc: 'Interni moderni e arredi nuovi per un soggiorno confortevole.' },
      ...
      { title: 'Parcheggio', desc: 'Posto auto disponibile per gli ospiti di Casa Marittima.' },
  ...
  de: {
    ...
    items: [
      { title: 'Neu renoviert', desc: 'Modernes Interieur und neue Möbel für einen angenehmen Aufenthalt.' },
      ...
      { title: 'Parkplatz', desc: 'Ein Gästeparkplatz steht für Casa Marittima zur Verfügung.' },
  ...
  cs: {
    ...
    items: [
      { title: 'Nová rekonstrukce', desc: 'Moderní interiér a nový nábytek pro pohodlný pobyt.' },
      ...
      { title: 'Parkování', desc: 'Parkovací místo je hostům Casa Marittima k dispozici.' },
