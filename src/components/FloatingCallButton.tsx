...
const FloatingCallButton: React.FC = () => {
  ...
  return (
    <a 
      ...
      className="fixed bottom-24 right-6 z-[100] sm:hidden bg-indigo-600 text-white p-4 rounded-full shadow-2xl border border-white/10 flex items-center space-x-2 animate-bounce-slow"
    >
