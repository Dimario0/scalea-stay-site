...
const COPY: Record<string, HeroCopy> = {
  ...
  en: {
    ...
    subtitle: 'ScaleaStay is a modern apartment for a seaside holiday, with the beach, supermarket, train station and central Scalea all within walking distance.',
  ...
  de: {
    ...
    subtitle: 'ScaleaStay ist eine moderne Ferienwohnung für einen Urlaub am Meer. Strand, Supermarkt, Bahnhof und das Zentrum von Scalea sind bequem zu Fuß erreichbar.',
  ...
  cs: {
    ...
    subtitle: 'ScaleaStay je moderní apartmán pro dovolenou u moře. Pláž, supermarket, nádraží i centrum města Scalea jsou pohodlně dostupné pěšky.',
