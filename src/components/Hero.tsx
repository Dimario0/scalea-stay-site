...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 scroll-mt-40">
      <div 
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center pt-24 md:pt-32">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[120px] font-[900] text-white leading-[0.9] sm:leading-[0.8] tracking-tighter mb-10 animate-fade-in drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)] uppercase">
          {t('heroTitle')}
        </h1>
        
        <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-14 max-w-2xl mx-auto font-medium leading-relaxed animate-fade-in drop-shadow-lg" style={{ animationDelay: '0.2s' }}>
          {t('heroSubtitle')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <a 
            ...
            className="w-full sm:w-auto bg-white text-slate-950 px-14 py-6 rounded-[28px] font-black text-xl transition-all hover:bg-indigo-50 hover:-translate-y-1 shadow-[0_20px_50px_rgba(255,255,255,0.2)] active:scale-95 text-center"
          >
            {t('ourApartments')}
          </a>
          <a 
            ...
            className="w-full sm:w-auto px-12 py-6 rounded-[28px] font-black text-white border-2 border-white/40 backdrop-blur-md hover:bg-white/10 transition-all flex items-center justify-center space-x-4 group text-lg"
          >
