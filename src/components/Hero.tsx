  ...
  return (
    <section id="home" className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-slate-950 scroll-mt-40">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center pt-24 md:pt-32">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center animate-fade-in w-full max-w-md sm:max-w-none mx-auto" style={{ animationDelay: '0.4s' }}>
          <a 
            href="#apartments" 
