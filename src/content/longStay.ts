...
export const LONG_STAY_COPY = {
  ru: {
    wifi: 'Wi-Fi', heating: 'Газовое отопление', layout: 'Одна спальня и терраса',
  ...
  en: {
    wifi: 'Wi-Fi', heating: 'Gas heating', layout: 'One bedroom and a terrace',
  ...
  it: {
    wifi: 'Wi-Fi', heating: 'Riscaldamento a gas', layout: 'Una camera da letto e terrazza',
  ...
  de: {
    wifi: 'WLAN', heating: 'Gasheizung', layout: 'Ein Schlafzimmer und Terrasse',
  ...
  cs: {
    wifi: 'Wi-Fi', heating: 'Plynové topení', layout: 'Jedna ložnice a terasa',
  ...
  pl: {
    wifi: 'Wi-Fi', heating: 'Ogrzewanie gazowe', layout: 'Jedna sypialnia i taras',
